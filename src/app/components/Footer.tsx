    ...
    <div className="">
      <footer className=" px-8 py-18 md:py-3 lg:py-4 bg-[#333333] h-auto min-h-[700px] md:min-h-[220px] lg:min-h-[250px] xl:min-h-[690px]">
        ...
        <p className="text-sm text-gray-300 md:text-[12px] lg:text-[14px] xl:text-[17px] md:whitespace-normal">
          Devloop is a forward-thinking software company committed to
          building powerful, scalable, and intuitive web applications. We
          specialize in crafting modern digital solutions tailored for
          startups, businesses, and enterprises, using cutting-edge
          ...
          system, Devloop delivers solutions that are not only technically
          strong but also user-centric and future-ready.
        </p>
          </div>
        ...
        <div className="flex space-x-4 text-gray-300">
          <Linkedin className="hover:text-[#0077b5] cursor-pointer" />
          <Facebook className="hover:text-[#3b5998] cursor-pointer" />
          <Twitter className="hover:text-[#1da1f2] cursor-pointer" />
        </div>
          </div>

          {/* Newsletter */}
          <div>
        <h2 className="text-xl font-semibold mb-4 text-white xl:text-2xl">
